...
<div class="row row-cols-1 row-cols-md-3 g-4">
  <div class="col">
    <div class="card h-100">
      <img src="img\ang.webp" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"> COURSE OF THURSDAY, NOVEMBER 27 </h5>
        <p class="card-text">The lesson focuses on how to use link words to express contrast, cause, and result. 
        To express result, it introduces therefore, so, consequently, and as a result, all used to show the consequence of a situation.
        Finally, exercises ask students to choose the correct connector depending on whether the sentence requires expressing contrast, cause, result, or addition.</p>
      </div>
      <div class="card-footer">
        <button type="button" class="btn btn-outline-danger"> FULL COURSE </button>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card h-100">
      <img src="img\ang.webp" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"> COURSE OF THURSDAY, NOVEMBER 20 </h5>
        <p class="card-text">We Study a article about "The new helicopter bosses," which refers to managers who intensely micromanage their remote employees, especially since the pandemic.  
        From a study cited in the text,  38% of managers doubted their workers' productivity.</p>
      </div>
      <div class="card-footer">
        <button type="button" class="btn btn-outline-danger"> FULL COURSE </button>
      </div>
  ...
  <div class="col">
    <div class="card h-100">
      <img src="img\ang.webp" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"> COURSE OF THURSDAY, NOVEMBER 13  </h5>
        <p class="card-text"> Our teacher had to leave so he gave us a Test  with a written expression, an understanding of text, to keep us in class.</p>
      </div>
      <div class="card-footer">
        <button type="button" class="btn btn-outline-danger"> FULL COURSE </button>
      </div>
