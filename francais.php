...
<div class="row row-cols-1 row-cols-md-3 g-4">
  <div class="col">
    <div class="card h-100">
      <img src="img\fr.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"> COURS VENDREDI 28 NOVEMBRE</h5>
        <p class="card-text">Finalisation du choix du livres pour la fiches de lecture.
        Débat sur l'actualité de la semaine, comme à chaque cours !</p>
      </div>
      <div class="card-footer">
        <button type="button" class="btn btn-outline-warning"> COURS COMPLET </button>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card h-100">
      ...
      <div class="card-body">
        ...
        <p class="card-text"> Étude et lecture des textes suivants : <br>
    - Imaginer l’animal : entre mythes et symboles <br>
    - Connaître l’animal : une révolution des savoirs <br>
    - Comprendre l’animal : une question d’éthique et de société <br>
    - L’animal comme miroir de l’humanité <br>
    Débat sur l'actualité de la semaine, comme à chaque cours !
</p>
      </div>
      <div class="card-footer">
        <button type="button" class="btn btn-outline-warning"> COURS COMPLET </button>
  ...
  <div class="col">
    <div class="card h-100">
      ...
      <div class="card-body">
        ...
        <p class="card-text"> Étude et lecture du document : Les animaux et nous : imaginer, connaître, comprendre l’animal.
        Débat sur l'actualité de la semaine, comme à chaque cours !  </p>
      </div>
      <div class="card-footer">
        <button type="button" class="btn btn-outline-warning"> COURS COMPLET </button>
